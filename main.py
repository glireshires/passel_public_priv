...
pins_channel = 1001303796829409280

# TODO
# add any black listed channel IDs as a list separated by a comma (,)
# a good idea is to add admin channels to this
blacklisted_channels = [919130216981467186,919130214741725254,919130236157829121,919130582762520617,919871761951100929,1001303796829409280,919131186469679135,937546471862063104,1003076569843122287,919130216981467186,919130214741725254,919130236157829121,919130582762520617,919871761951100929,931067535305101343,967592413675786240,919130492522078249,919130885268307968,937549262412185660,973398547103903784,928753871109627984,919130948182896680,935291996216639580,937048121127624724,1010607739271131256,921317569586143262]

# 919131186469679135 = our-art
# 937546471862063104 = our-writing
# 1003076569843122287 = jc-revival
# 919130216981467186 = rp-planning
# 919130214741725254 = grillo-ocs
# 919130236157829121 = eck-ocs
# 919130582762520617 = ed-ocs
# 919871761951100929 = arrival
# 931067535305101343 = vc
# 967592413675786240 = idv-rank-ref
# 919130492522078249 = uglydolls
# 919130885268307968 = trollhunters
# 937549262412185660 = aot
# 973398547103903784 = owl-house
# 928753871109627984 = history
# 919130948182896680 = psych
# 935291996216639580 = phil
# 937048121127624724 = bio
# 1010607739271131256 = chem
# 921317569586143262 = vocab
